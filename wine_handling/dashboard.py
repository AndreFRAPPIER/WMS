...
class WMS:
    def __init__(self, root) -> None:
        ...
        title = Label(self.root, text = "Alcool Management System", compound = LEFT, font = ("times new roman", 40, "bold"), bg = "#ba5390", fg = "white", anchor = "w", padx = 20).place(x = 0, y = 0, relwidth = 1, height = 70 )
